pipeline {
    ...
    environment {
        ...
        AWS_ACCOUNT_ID = '269599744150' //change this to your AWS_ACCOUNT_ID
        ECR_REPOSITORY = 'coding-challenge1-repo' //This will stay the same since your ECR_REPOSITORY name is the same 
